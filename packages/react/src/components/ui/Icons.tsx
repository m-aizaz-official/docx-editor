...
// Insert Symbol (Material Symbols "emoji_symbols"). Path shared with the Vue
// adapter via scripts/extract-icons.mjs, so it must stay an SvgIcon-wrapped
// <path> (the extractor only reads those).
...
// Insert Equation (Material Symbols "functions" — the ∑ glyph). Shared with Vue
// via scripts/extract-icons.mjs, so it stays an SvgIcon-wrapped <path>.
