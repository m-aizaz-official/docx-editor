...
import type { Document, SectionProperties } from '@sofcom/docx-editor-core/types/document';

// `findParaIdRange` moved to `@sofcom/docx-editor-core/prosemirror/paraText`;
