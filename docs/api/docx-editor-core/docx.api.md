...
// @public
export function calculateTabWidth(currentPosition: number, tabMarks: TabMark[], pageWidth: number): number;

// @public
export function calculateTabWidthWithAlignment(currentPosition: number, tabMarks: TabMark[], pageWidth: number, followingContentWidth?: number): {
    width: number;
...
// @public
export const DEFAULT_TAB_ALIGNMENT: TabJustify;
...
// @public
export function getNextTabMark(currentPosition: number, tabMarks: TabMark[], pageWidth: number): TabMark;
...
// @public
export function mergeTabMarks(styleTabs: TabMark[] | undefined, directTabs: TabMark[] | undefined): TabMark[];
...
// @public
export function parseTabMark(tab: Element_2): TabMark | null;

// @public
export function parseTabMarks(tabs: Element_2 | null): TabMark[];

// @public
export function parseTabMarksFromParagraphProperties(pPr: Element_2 | null): TabMark[] | undefined;
