...
import { AgentResponse } from '@docx-editor.dev/core/types/agentApi';
import { AIAction } from '@docx-editor.dev/core/types/agentApi';
import { ColorValue } from '@docx-editor.dev/core/types/document';
import { createDefaultFindOptions } from '@docx-editor.dev/core/utils/findReplace';
import { createDefaultListState } from '@docx-editor.dev/core/utils/listState';
import { createSearchPattern } from '@docx-editor.dev/core/utils/findReplace';
import { CSSProperties } from 'react';
import { Document as Document_2 } from '@docx-editor.dev/core/types/document';
import { escapeRegexString } from '@docx-editor.dev/core/utils/findReplace';
import { findAllMatches } from '@docx-editor.dev/core/utils/findReplace';
import { findInDocument } from '@docx-editor.dev/core/utils/findReplace';
import { findInParagraph } from '@docx-editor.dev/core/utils/findReplace';
import { FindMatch } from '@docx-editor.dev/core/utils/findReplace';
import { FindOptions } from '@docx-editor.dev/core/utils/findReplace';
import { FindResult } from '@docx-editor.dev/core/utils/findReplace';
import { FontOption } from '@docx-editor.dev/core/utils/fontOptions';
import { formatPageRange as formatPrintPageRange } from '@docx-editor.dev/core';
import { getDefaultHighlightOptions } from '@docx-editor.dev/core/utils/findReplace';
import { getDefaultPrintOptions } from '@docx-editor.dev/core';
import { getMatchCountText } from '@docx-editor.dev/core/utils/findReplace';
import { HighlightOptions } from '@docx-editor.dev/core/utils/findReplace';
import { isEmptySearch } from '@docx-editor.dev/core/utils/findReplace';
import { isPrintSupported } from '@docx-editor.dev/core';
import { ListState } from '@docx-editor.dev/core/utils/listState';
import { openPrintWindow } from '@docx-editor.dev/core';
import { ParagraphAlignment } from '@docx-editor.dev/core/types/document';
import { ParsedClipboardContent } from '@docx-editor.dev/core/utils';
import { parsePageRange } from '@docx-editor.dev/core';
import { PrintOptions } from '@docx-editor.dev/core';
import * as React$1 from 'react';
import React__default from 'react';
import { ReactNode } from 'react';
import { replaceAllInContent } from '@docx-editor.dev/core/utils/findReplace';
import { replaceFirstInContent } from '@docx-editor.dev/core/utils/findReplace';
import { scrollToMatch } from '@docx-editor.dev/core/utils/findReplace';
import { SectionProperties } from '@docx-editor.dev/core/types/document';
import { SelectionContext } from '@docx-editor.dev/core/types/agentApi';
import { Style } from '@docx-editor.dev/core/types/document';
import { StyleType } from '@docx-editor.dev/core/types/document';
import { Table } from '@docx-editor.dev/core/types/document';
import { TableCell } from '@docx-editor.dev/core/types/document';
import { TabMark } from '@docx-editor.dev/core/types/document';
import { Theme } from '@docx-editor.dev/core/types/document';
import { TranslationKey } from '@docx-editor.dev/i18n';
import { triggerPrint } from '@docx-editor.dev/core';
