## API Report File for "@sofcom/docx-editor-react"

> Do not edit this file. It is a report generated by [API Extractor](https://api-extractor.com/).

```ts

import { AgentResponse } from '@sofcom/docx-editor-core/types/agentApi';
import { AIAction } from '@sofcom/docx-editor-core/types/agentApi';
import { ColorValue } from '@sofcom/docx-editor-core/types/document';
import { createDefaultFindOptions } from '@sofcom/docx-editor-core/utils/findReplace';
import { createDefaultListState } from '@sofcom/docx-editor-core/utils/listState';
import { createSearchPattern } from '@sofcom/docx-editor-core/utils/findReplace';
import { CSSProperties } from 'react';
import { Document as Document_2 } from '@sofcom/docx-editor-core/types/document';
import { escapeRegexString } from '@sofcom/docx-editor-core/utils/findReplace';
import { findAllMatches } from '@sofcom/docx-editor-core/utils/findReplace';
import { findInDocument } from '@sofcom/docx-editor-core/utils/findReplace';
import { findInParagraph } from '@sofcom/docx-editor-core/utils/findReplace';
import { FindMatch } from '@sofcom/docx-editor-core/utils/findReplace';
import { FindOptions } from '@sofcom/docx-editor-core/utils/findReplace';
import { FindResult } from '@sofcom/docx-editor-core/utils/findReplace';
import { FontOption } from '@sofcom/docx-editor-core/utils/fontOptions';
import { formatPageRange as formatPrintPageRange } from '@sofcom/docx-editor-core';
import { getDefaultHighlightOptions } from '@sofcom/docx-editor-core/utils/findReplace';
import { getDefaultPrintOptions } from '@sofcom/docx-editor-core';
import { getMatchCountText } from '@sofcom/docx-editor-core/utils/findReplace';
import { HighlightOptions } from '@sofcom/docx-editor-core/utils/findReplace';
import { isEmptySearch } from '@sofcom/docx-editor-core/utils/findReplace';
import { isPrintSupported } from '@sofcom/docx-editor-core';
import { ListState } from '@sofcom/docx-editor-core/utils/listState';
import { openPrintWindow } from '@sofcom/docx-editor-core';
import { ParagraphAlignment } from '@sofcom/docx-editor-core/types/document';
import { ParsedClipboardContent } from '@sofcom/docx-editor-core/utils';
import { parsePageRange } from '@sofcom/docx-editor-core';
import { PrintOptions } from '@sofcom/docx-editor-core';
import * as React$1 from 'react';
import React__default from 'react';
import { ReactNode } from 'react';
import { replaceAllInContent } from '@sofcom/docx-editor-core/utils/findReplace';
import { replaceFirstInContent } from '@sofcom/docx-editor-core/utils/findReplace';
import { scrollToMatch } from '@sofcom/docx-editor-core/utils/findReplace';
import { SectionProperties } from '@sofcom/docx-editor-core/types/document';
import { SelectionContext } from '@sofcom/docx-editor-core/types/agentApi';
import { Style } from '@sofcom/docx-editor-core/types/document';
import { StyleType } from '@sofcom/docx-editor-core/types/document';
import { Table } from '@sofcom/docx-editor-core/types/document';
import { TableCell } from '@sofcom/docx-editor-core/types/document';
import { TabMark } from '@sofcom/docx-editor-core/types/document';
import { Theme } from '@sofcom/docx-editor-core/types/document';
import { triggerPrint } from '@sofcom/docx-editor-core';
...
// @public
export type TextContextAction = 'cut' | 'copy' | 'paste' | 'pasteAsPlainText' | 'selectAll' | 'delete' | 'separator' | 'addRowAbove' | 'addRowBelow' | 'deleteRow' | 'addColumnLeft' | 'addColumnRight' | 'deleteColumn' | 'mergeCells' | 'splitCell' | 'selectTable' | 'deleteTable' | 'updateTableOfContents' | 'addComment' | 'restartNumbering' | 'continueNumbering';
